...
* **Sales by City (Map Visualization)**
  Shows geographical distribution of sales across major cities

* **Monthly Sales Trend (Line Chart)**
  Highlights fluctuations and seasonal trends in sales

* **Customer Ratings (Bar Chart)**
  Shows distribution of customer satisfaction levels

* **Transaction by Payment Method (Pie Chart)**
  Compares usage of UPI, Debit Card, Credit Card, and Cash

* **Brand-wise Performance (Table)**
  Compares total sales, quantity, and transactions across brands
...
* 💳 **Payment Behavior:** Digital payments (UPI, cards) dominate transactions
